...
object DatabaseFactory {
    ...
    fun seedData(connection: Connection) {
        ...
        connection.createStatement().use { st ->
            ...
            st.executeUpdate("UPDATE attractions SET image_path='https://commons.wikimedia.org/wiki/Special:FilePath/Fort%20Santiago%20Gate.jpg', image_urls='[\"https://commons.wikimedia.org/wiki/Special:FilePath/Fort%20Santiago%20Gate.jpg\",\"https://commons.wikimedia.org/wiki/Special:FilePath/Fort%20Santiago%2C%20Intramuros.JPG\"]' WHERE slug='fort-santiago'")
            st.executeUpdate("UPDATE attractions SET image_path='https://commons.wikimedia.org/wiki/Special:FilePath/San_Agustin_Church_Manila.jpg', image_urls='[\"https://commons.wikimedia.org/wiki/Special:FilePath/San_Agustin_Church_Manila.jpg\",\"https://commons.wikimedia.org/wiki/Special:FilePath/San_Agustin_Church_%28Manila%29.jpg\"]' WHERE slug='san-agustin-church'")
            ...
            st.executeUpdate("UPDATE attractions SET image_path='https://commons.wikimedia.org/wiki/Special:FilePath/Casa_Manila.jpg', image_urls='[\"https://commons.wikimedia.org/wiki/Special:FilePath/Casa_Manila.jpg\",\"https://commons.wikimedia.org/wiki/Special:FilePath/CasaManilajf1591_12.JPG\"]' WHERE slug='casa-manila'")
            st.executeUpdate("UPDATE attractions SET image_path='https://commons.wikimedia.org/wiki/Special:FilePath/Minor_Basilica_and_Metropolitan_Cathedral_of_the_Immaculate_Conception.jpg', image_urls='[\"https://commons.wikimedia.org/wiki/Special:FilePath/Minor_Basilica_and_Metropolitan_Cathedral_of_the_Immaculate_Conception.jpg\",\"https://commons.wikimedia.org/wiki/Special:FilePath/Manila_Cathedral_2018.jpg\"]' WHERE slug='manila-cathedral'")
            ...
            st.executeUpdate("UPDATE attractions SET image_path='https://commons.wikimedia.org/wiki/Special:FilePath/Intramuros_wall.jpg', image_urls='[\"https://commons.wikimedia.org/wiki/Special:FilePath/Intramuros_wall.jpg\",\"https://commons.wikimedia.org/wiki/Special:FilePath/Manila%2C_Intramuros_walls%2C_Philippines.jpg\"]' WHERE slug='intramuros-walls-walk'")
            st.executeUpdate("UPDATE attractions SET image_path='https://commons.wikimedia.org/wiki/Special:FilePath/Plaza_San_Luis_Complex.jpg', image_urls='[\"https://commons.wikimedia.org/wiki/Special:FilePath/Plaza_San_Luis_Complex.jpg\"]' WHERE slug='plaza-san-luis-complex'")
            st.executeUpdate("UPDATE attractions SET image_path='https://commons.wikimedia.org/wiki/Special:FilePath/Puerta_del_Parian%2C_Intramuros.jpg', image_urls='[\"https://commons.wikimedia.org/wiki/Special:FilePath/Puerta_del_Parian%2C_Intramuros.jpg\"]' WHERE slug='puerta-del-parian'")
